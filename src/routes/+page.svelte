...
<div class="min-h-screen flex items-center justify-center font-poppins text-white p-4">
    <div class="w-full max-w-md h-auto bg-transparentblue p-6 rounded-md flex flex-col pointer-events-auto">
        ...
        <div class="w-full flex items-center justify-center sm:justify-start gap-4">
            <a href="https://github.com/Nolankicks" class="w-12 h-12 rounded-md shrink-0 hover:scale-105 transition-all active:scale-95" style="background-image: url({githubUrl}); background-size: cover;">
                <span class="sr-only">GitHub Profile</span>
            </a>
            <a href="https://sbox.game/nolankicks" class="w-12 h-12 rounded-md shrink-0 hover:scale-105 transition-all active:scale-95" style="background-image: url({sboxUrl}); background-size: cover;">
